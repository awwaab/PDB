  ...
  <html>
    ...
    <body class="categorical grey lighten-3">
      ...
      <div class="container white-box">
        ...
        <div class="row">
          <h1 class ="heads-topics center-align">Public health</h1>
          <h3 class ="heads-topics center-align">Everything they said about the public health</h3>
        ...
        <?php 
         ...
         //for Hillay clinton
          ...
          foreach ($entityLists as $entity) {
            ...
            if ($speaker == "Clinton" and $tag == "9.0" and $countClinton%2 ==0){
                 echo "<p class='amber-text text-lighten-3'> $content </p>";
                 $countClinton += 1;
               }
             elseif ($speaker == "Clinton" and $tag == "9.0" and $countClinton%2 ==1){
                 echo "<p> $content </p>";
                 $countClinton += 1;
             }
          ...
          echo "<div class = 'col s6-mod content red darken-3 flexible'>";
            ...
            foreach ($entityLists as $entity) {
             ...
             if ($speaker == "Trump" and $tag == "9.0" and $countTrump%2 ==0){
                 echo "<p class='amber-text text-lighten-3'> $content </p>";
                 $countTrump += 1;
               }
             elseif ($speaker == "Trump" and $tag == "9.0" and $countTrump%2 ==1){
                 echo "<p> $content </p>";
                 $countTrump += 1;
             }
